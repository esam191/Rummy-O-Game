...
function getAPI(opts) {
    ...
    api.get("/room", (req, res) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const [_, inspectData] = yield colyseus_1.matchMaker.remoteRoomCall(roomId, "getInspectData");
    ...
    api.get("/room/call", (req, res) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const [_, data] = yield colyseus_1.matchMaker.remoteRoomCall(roomId, method, args);
            res.json(data);
        }
        catch (e) {
            const message = UNAVAILABLE_ROOM_ERROR.replace("$roomId", roomId);
