...
## Play Turn
When the game starts,the players will have to either play a run or a set and each player will have the chance to add to the table if they are unable to add to the run or the set the player will be subjected to pick a tile form the tile deck.
